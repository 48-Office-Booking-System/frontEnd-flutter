                ...
                Container(
                  ...
                  child: DropdownButton(
                    ...
                    items: const [
                      ...
                      DropdownMenuItem(
                        value: 1,
                        child: Text("1 - 10 Orang"),
                      ),
                      DropdownMenuItem(
                        value: 2,
                        child: Text("11 - 20 Orang"),
                      ),
                      DropdownMenuItem(
                        value: 1,
                        child: Text("21 - 30 Orang"),
                      ),
                      DropdownMenuItem(
                        value: 2,
                        child: Text("31 - 40 Orang"),
                      ),
                      DropdownMenuItem(
                        value: 1,
                        child: Text("41 - 50 Orang"),
                      ),
                      DropdownMenuItem(
                        value: 2,
                        child: Text("51 - 60 Orang"),
                      ),
                    ],
                  ),
                ),
