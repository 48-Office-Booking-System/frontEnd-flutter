...
PostAddNewUser postAddNewUserFromJson(String str) =>
    PostAddNewUser.fromJson(json.decode(str));

String postAddNewUserToJson(PostAddNewUser data) => json.encode(data.toJson());

class PostAddNewUser {
  PostAddNewUser({
    required this.id,
    required this.role,
    required this.name,
  ...
  factory PostAddNewUser.fromJson(Map<String, dynamic> json) => PostAddNewUser(
        id: json["id"],
