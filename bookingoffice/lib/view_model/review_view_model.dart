...
class RiviewViewModel with ChangeNotifier {
  ...
  List<ReviewModel> riviewModelData = [
    ReviewModel(
      ...
      title: 'Meeting diruangan ini nyaman banget',
          // 'Meeting diruangan ini nyaman banget, adem. Pokoknya ga bosen meeting lama - lama disini. Pelayanannya juga bagus, lengkap, dan sesuai dengan kebutuhan untuk meeting.',
    ),
    ReviewModel(
      name: 'Dina',
      img: 'assets/images/dina.png',
      title: 'Harga sewanya terjangkau',
          // 'Harga sewanya terjangkau. Ruangannya juga luas, cukup buat banyak orang. Tapi AC nya tidak terlalu dingin, jadi agak panas. Fasilitasnya juga cukup bagus.',
    ),
    ReviewModel(
      name: 'Nana',
      img: 'assets/images/nana.png',
      title: 'letaknya juga strategis',
          // 'Karyawannya kurang ramah, tapi fasilitasnya cukup baik. Overall, baik deh. letaknya juga strategis',
    ),
  ];
