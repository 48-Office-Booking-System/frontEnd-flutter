    ...
    return Scaffold(
      ...
      children: [
        ...
        Container(
          ...
          child: TextField(
            cursorColor: Color(0xff303B79),
            decoration: InputDecoration(
              focusColor: Color(0xff303B79),
              icon: Icon(
                Icons.vpn_key,
                color: Color(0xff121950),
              ),
        ...
        Container(
          ...
          child: GestureDetector(
            ...
            child: Text(
              "Forget Password?",
              style: TextStyle(color: Color(0xff121950)),
            ),
          ),
        ),
        GestureDetector(
          ...
          child: Container(
            ...
            decoration: BoxDecoration(
              gradient: LinearGradient(
                  colors: [(new Color(0xff121950)), new Color(0xff303B79)],
          ...
          child: Row(
            ...
            children: [
              ...
              GestureDetector(
                child: Text(
                  "Register Now",
                  style: TextStyle(color: new Color(0xff121950)),
                ),
                onTap: () {
                  // Write Tap Code Here.
                  Navigator.push(
