...
//
//     final putUpUserId = putUpUserIdFromJson(jsonString);

import 'dart:convert';

PutUpUserId putUpUserIdFromJson(String str) => PutUpUserId.fromJson(json.decode(str));

String putUpUserIdToJson(PutUpUserId data) => json.encode(data.toJson());
...
class PutUpUserId {
    ...
    factory PutUpUserId.fromJson(Map<String, dynamic> json) => PutUpUserId(
        id: json["id"],
...
class Office {
    ...
    factory Office.fromJson(Map<String, dynamic> json) => Office(
        ...
        number: json["number"],
        photoUrls: List<PhotoUrl>.from(json["photo_urls"].map((x) => PhotoUrl.fromJson(x))),
        facilitations: List<Role>.from(json["facilitations"].map((x) => Role.fromJson(x))),
    ...
    Map<String, dynamic> toJson() => {
        ...
        "facilitations": List<dynamic>.from(facilitations.map((x) => x.toJson())),
